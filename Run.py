...
class Run:
    ...
    def parse_file(base, filename):
        timestamp = Run.parse_date(filename)
        challenge_name = Run.parse_challenge_name(filename)
        ...
        return Run(challenge_name, score, damage_done, damage_done / damage_possible, timestamp)
